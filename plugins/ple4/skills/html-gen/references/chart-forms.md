...
| 帯 | 必要量 |
|---|---|
| 左（値の目盛り） | 最長の目盛り文字列の幅 + 10。5 桁 + 桁区切りなら 55 前後 |
| 左（軸の名前を縦書きで置くとき） | 上記にさらに +20。**目盛りの幅に重ねない** |
| 下（分類ラベル 1 行） | フォントサイズ + 14。20 前後 |
| 下（軸の名前も置くとき） | 上記にさらに +18 |
| 右 | 16。ただし棒の先に値を置くなら、その文字列の幅 + 8 |
...
<div class="chart-scroll">
  <svg class="chart chart--hbars" role="img" viewBox="0 0 720 422"
    ...
    <line class="grid-line" x1="118" y1="10" x2="118" y2="392"/>
    <text class="axis-text" x="118" y="412" text-anchor="middle">0</text>
    <line class="axis-line" x1="118" y1="10" x2="118" y2="392"/>
    <rect class="bar--h" style="--i: 0" x="118" y="10" width="565" height="22" rx="4" fill="var(--chart-1)">
      <title>神奈川県横浜港北店 4,820 万円</title>
    </rect>
    <text class="axis-text" x="108" y="26" text-anchor="end">神奈川県横浜港北店</text>
    <text class="axis-text bar-value" x="691" y="26">4,820</text>
...
区切りは**面の色の 2px の隙間**が作る（各区画の幅から 2 を引く）。枠線を描かない。
