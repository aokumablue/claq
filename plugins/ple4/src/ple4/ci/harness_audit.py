...
def _consumer_tool_coverage_checks(root_dir: str | Path, plugin_install: str | None) -> list[dict[str, Any]]:
    ...
    return [
        ...
        },
        {
            ...
            "fix": "Add project-local .claude hooks, commands, skills, or settings that tailor ple4 to this repo.",
        },
    ]
...
def show_help(exit_code: int = 0) -> None:
    ...
    print(
        """
Usage: python3 "${CLAUDE_PLUGIN_ROOT}/src/ple4/launcher.py" ple4.ci.harness_audit [scope] [--scope <repo|hooks|skills|commands|agents>] [--format <text|json>]
