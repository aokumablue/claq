"""ple4.ci.scan_scaffold_drift のテスト。"""
...
from ple4.ci import scan_scaffold_drift as scanner
...
class TestKnownTags:
    ...
    def test_derived_from_definition_modules(self) -> None:
        ...
        from ple4.mem.tag_stripping import STRIPPED_TAGS
...
class TestMain:
    ...
    def test_module_entrypoint_runs(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        with pytest.raises(SystemExit) as excinfo:
            runpy.run_module("ple4.ci.scan_scaffold_drift", run_name="__main__")
