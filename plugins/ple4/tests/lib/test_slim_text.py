...
def test_strip_markdown_prefix_variants() -> None:
    """各種マークダウン記号を正しく処理する。"""
    from ple4.lib.slim_text import _strip_markdown_prefix
...
def test_first_meaningful_line_all_stripped() -> None:
    ...
    from ple4.lib.slim_text import first_meaningful_line
...
def test_normalize_line_markdown_only_becomes_empty() -> None:
    ...
    from ple4.lib.slim_text import _normalize_line
