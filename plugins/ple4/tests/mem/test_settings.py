...
from ple4.mem.settings import Settings
...
def test_default_data_dir_uses_ple4_data_path_env(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> None:
    """PLE4_DATA_PATH があればモジュール再読込時にそれをデータディレクトリにする。"""
