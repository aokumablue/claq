...
import claq.ci.validate_agents as validate_agents
import claq.ci.validate_commands as validate_commands
import claq.ci.validate_skills as validate_skills
...
def test_extract_frontmatter_skips_lines_without_colon() -> None:
    ...
    from claq.ci.validate_agents import extract_frontmatter
