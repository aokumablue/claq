...
bluecore.mem._paths と model_build._paths は配布独立のため import 関係を持たず、
...
_MEM_PATHS = _ROOT / "src" / "bluecore" / "mem" / "_paths.py"
...
class TestPathsParity:
    ...
    def test_bodies_match_excluding_module_docstring(self) -> None:
        ...
        assert mem_body == modelbuild_body, (
            "bluecore.mem._paths と model_build._paths の本体が乖離しています。"
