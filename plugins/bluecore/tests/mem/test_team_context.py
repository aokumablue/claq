...
def test_build_team_context_hybrid_uses_team_search(
    ...
    from bluecore.mem import team_context as module
    ...
    monkeypatch.setattr("bluecore.mem.embedding.embed_query", _fake_embed)
...
def test_format_chunk_empty_fields() -> None:
    ...
    from bluecore.mem.team_context import _format_chunk
