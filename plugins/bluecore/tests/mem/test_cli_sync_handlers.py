...
class TestHandleSyncCheckVisibility:
    ...
    def test_logs_info_on_skip(self, mock_settings, monkeypatch):
        ...
        # 遅延 import のため bluecore.mem.sync 側でパッチする
        monkeypatch.setattr("bluecore.mem.sync.should_sync", lambda _: False)
        log = MagicMock()

        from bluecore.mem.cli_sync_handlers import handle_sync_check
    ...
    def test_logs_error_on_failure(self, mock_settings, monkeypatch, capsys):
        ...
        monkeypatch.setattr("bluecore.mem.sync.should_sync", lambda _: True)
        monkeypatch.setattr(
...
class TestHandleSyncStatus:
    ...
    def test_sync_status_json_structure(
        ...
        monkeypatch.setattr(
            "bluecore.mem.cli_sync_handlers._check_psycopg", lambda: psycopg_ok
        )
        ...
        monkeypatch.setattr(
            "bluecore.mem.cli_sync_handlers._test_pg_connection",
            lambda url, installed: conn_result,
        )
        monkeypatch.setattr(
            "bluecore.mem.cli_sync_handlers._count_all_pending", lambda _: 7
        )

        from bluecore.mem.cli_sync_handlers import handle_sync_status
    ...
    def test_password_masked_in_url(self, mock_settings, monkeypatch, capsys):
        ...
        monkeypatch.setattr("bluecore.mem.cli_sync_handlers._check_psycopg", lambda: False)
        monkeypatch.setattr(
            "bluecore.mem.cli_sync_handlers._test_pg_connection",
            lambda url, installed: ("skipped", "psycopg が未インストールです"),
        )
        monkeypatch.setattr("bluecore.mem.cli_sync_handlers._count_all_pending", lambda _: 0)
    ...
    def test_url_none_when_not_set(self, mock_settings, monkeypatch, capsys):
        ...
        monkeypatch.setattr("bluecore.mem.cli_sync_handlers._check_psycopg", lambda: True)
        monkeypatch.setattr(
            "bluecore.mem.cli_sync_handlers._test_pg_connection",
...
class TestBuildSyncStatusDict:
    ...
    def test_lite_mode_skips_connection(self, mock_settings, monkeypatch):
        ...
        called = []
        monkeypatch.setattr(
            "bluecore.mem.cli_sync_handlers._check_psycopg", lambda: True
        )
        monkeypatch.setattr(
            "bluecore.mem.cli_sync_handlers._test_pg_connection",
        ...
        from bluecore.mem.cli_sync_handlers import _build_sync_status_dict
    ...
    def test_full_mode_calls_connection(self, mock_settings, monkeypatch):
        ...
        monkeypatch.setattr(
            "bluecore.mem.cli_sync_handlers._count_all_pending", lambda _: 3
        )
...
class TestBuildSyncRecommendations:
    ...
    def test_each_branch(self, scenario, status_override, expected_keyword):
        ...
        from bluecore.mem.cli import _build_sync_recommendations
...
class TestHandleSetup:
    ...
    def test_logs_warning_when_initialize_db_fails(self, mock_settings, monkeypatch, caplog):
        ...
        monkeypatch.setattr(
            "bluecore.mem.cli._initialize_db",
            lambda settings, **kw: (_ for _ in ()).throw(RuntimeError("db error")),
        )
        monkeypatch.setattr(
            "bluecore.mem.cli_sync_handlers._build_sync_status_dict",
        ...
        from bluecore.mem.cli import _handle_setup

        with caplog.at_level(logging.WARNING, logger="bluecore.mem.CLI"):
    ...
    def test_emits_sync_diagnostics(self, mock_settings, monkeypatch, caplog):
        ...
        monkeypatch.setattr("bluecore.mem.cli._initialize_db", lambda settings, **kw: None)

        from bluecore.mem.cli import _handle_setup

        with caplog.at_level(logging.INFO, logger="bluecore.mem.CLI"):
            _handle_setup(mock_settings)
...
class TestInternalHelpers:
    ...
    def test_check_psycopg_true_when_available(self, monkeypatch):
        ...
        from bluecore.mem.cli_sync_handlers import _check_psycopg
    ...
    def test_test_pg_connection_skipped_when_no_url(self):
        ...
        from bluecore.mem.cli_sync_handlers import _test_pg_connection
    ...
    def test_test_pg_connection_failed_when_test_returns_false(self, monkeypatch):
        ...
        monkeypatch.setattr("bluecore.mem.pg_database.PgDatabase", FalsePgDb)
    ...
    def test_test_pg_connection_failed_on_exception(self, monkeypatch):
        ...
        monkeypatch.setattr("bluecore.mem.pg_database.PgDatabase", BoomPgDb)
    ...
    def test_count_all_pending_returns_zero_on_exception(self, mock_settings, monkeypatch):
        ...
        monkeypatch.setattr("bluecore.mem.database.Database", BoomDatabase)

        from bluecore.mem.cli_sync_handlers import _count_all_pending
    ...
    def test_count_all_pending_returns_total_on_success(self, mock_settings, monkeypatch):
        ...
        monkeypatch.setattr(
            "bluecore.mem.sync._count_pending_rows",
            lambda conn, table: 3,
        )
        ...
        from bluecore.mem.cli_sync_handlers import _count_all_pending
        from bluecore.mem.sync import _SYNC_TABLES
...
class TestSplitPassword:
    ...
    def test_url_with_password_splits(self) -> None:
        from bluecore.mem.cli_sync_handlers import _split_password
...
class TestWritePgpass:
    ...
    def test_creates_pgpass_file(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        from bluecore.mem.cli_sync_handlers import _write_pgpass
    ...
    def test_appends_to_existing_and_fixes_permissions(self, tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        monkeypatch.setattr(smod, "_DEFAULT_DATA_DIR", tmp_path / ".bluecore")
        pgpass = tmp_path / ".bluecore" / ".pgpass"
