...
from bluecore.mem.bridge import _epoch_to_iso, chunk_to_observation, sync_session_to_observations
...
class TestSyncSessionToObservations:
    ...
    def test_writes_observations(self, tmp_path: Path, monkeypatch) -> None:
        ...
        obs_dir = tmp_path / ".bluecore" / "projects" / "proj"
        ...
        monkeypatch.setattr("bluecore.mem.bridge._get_project_id", fake_get_project_id)
        monkeypatch.setattr("bluecore.mem.bridge._get_project_observations_path", fake_get_path)
