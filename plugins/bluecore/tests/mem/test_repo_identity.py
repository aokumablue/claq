"""bluecore.mem.repo_identity — 正体キー解決・スラッグ採番のテスト。"""
...
class TestNormalizeRemoteUrl:
    ...
    @pytest.mark.parametrize(
        ...
        [
            # ssh (scp 形式)
            ("git@github.com:aokumablue/bluecore-dev.git", "github.com/aokumablue/bluecore-dev"),
            ("git@github.com:aokumablue/bluecore-dev", "github.com/aokumablue/bluecore-dev"),
            ("github.com:aokumablue/bluecore-dev.git", "github.com/aokumablue/bluecore-dev"),
            # scp 形式でスラッシュを含まないパス
            ("git@github.com:bluecore-dev.git", "github.com/bluecore-dev"),
            ("git@GitHub.COM:aokumablue/bluecore-dev.git", "github.com/aokumablue/bluecore-dev"),
            ("git@github.com:/aokumablue/bluecore-dev.git/", "github.com/aokumablue/bluecore-dev"),
            # ssh (scheme 形式・ポート付き)
            ("ssh://git@github.com/aokumablue/bluecore-dev.git", "github.com/aokumablue/bluecore-dev"),
            ("ssh://git@github.com:22/aokumablue/bluecore-dev.git", "github.com/aokumablue/bluecore-dev"),
            ("ssh://git@GitHub.com:2222/aokumablue/bluecore-dev", "github.com/aokumablue/bluecore-dev"),
            # https
            ("https://github.com/aokumablue/bluecore-dev.git", "github.com/aokumablue/bluecore-dev"),
            ("https://github.com/aokumablue/bluecore-dev", "github.com/aokumablue/bluecore-dev"),
            ("https://github.com/aokumablue/bluecore-dev/", "github.com/aokumablue/bluecore-dev"),
            ("https://github.com/aokumablue/bluecore-dev.GIT", "github.com/aokumablue/bluecore-dev"),
            ("HTTPS://GitHub.com/aokumablue/bluecore-dev.git", "github.com/aokumablue/bluecore-dev"),
            # 認証情報付き
            ("https://user:token@github.com/aokumablue/bluecore-dev.git", "github.com/aokumablue/bluecore-dev"),
            ("https://user@github.com:443/aokumablue/bluecore-dev/", "github.com/aokumablue/bluecore-dev"),
            # git プロトコル
            ("git://github.com/aokumablue/bluecore-dev.git", "github.com/aokumablue/bluecore-dev"),
            # パス部の大小文字は保持する
            ("https://github.com/AokumaBlue/BlueCore-Dev.git", "github.com/AokumaBlue/BlueCore-Dev"),
            ...
            # ローカルパス remote
            ("/srv/git/bluecore-dev.git", "/srv/git/bluecore-dev"),
            ("/srv/git/bluecore-dev/", "/srv/git/bluecore-dev"),
            ("/srv/git/bluecore-dev", "/srv/git/bluecore-dev"),
            ("file:///srv/git/bluecore-dev.git", "/srv/git/bluecore-dev"),
            ("FILE:///srv/git/bluecore-dev/", "/srv/git/bluecore-dev"),
            ("../sibling-repo", "../sibling-repo"),
            # 最初のスラッシュより後ろのコロンはホスト区切りではない
            ("/srv/git/my:repo.git", "/srv/git/my:repo"),
            # 前後空白は無視する
            ("  git@github.com:aokumablue/bluecore-dev.git\n", "github.com/aokumablue/bluecore-dev"),
        ],
    )
    ...
    def test_ssh_https_and_bare_https_collapse_to_one_key(self) -> None:
        ...
        keys = {
            normalize_remote_url("git@github.com:aokumablue/bluecore-dev.git"),
            normalize_remote_url("https://github.com/aokumablue/bluecore-dev.git"),
            normalize_remote_url("https://github.com/aokumablue/bluecore-dev"),
        }
        assert keys == {"github.com/aokumablue/bluecore-dev"}
...
class TestSlugify:
    ...
    @pytest.mark.parametrize(
        ("name", "expected"),
        [
            ("bluecore-dev", "bluecore-dev"),
            ("BlueCore_Dev", "bluecore-dev"),
    ...
    def test_base_slug_uses_last_segment(self) -> None:
        ...
        remote_identity = RepoIdentity("github.com/aokumablue/bluecore-dev", "/x/y", "git@github.com:a/b.git")
        path_identity = RepoIdentity("/Users/x/dev/bluecore-dev", "/Users/x/dev/bluecore-dev", None)
        assert base_slug(remote_identity) == "bluecore-dev"
        assert base_slug(path_identity) == "bluecore-dev"
...
class TestResolveRepo:
    ...
    def test_registers_new_repo(self, tmp_path: Path, db: Database) -> None:
        ...
        root = _make_repo(tmp_path / "bluecore-dev", remote="git@github.com:aokumablue/bluecore-dev.git")
