...
from bluecore.skills.comply import scenario_generator as sg
from bluecore.skills.comply import spec_generator as sp
from bluecore.skills.comply.parser import ComplianceSpec, Detector, Step

FIXTURES = Path(__file__).resolve().parents[3] / "src" / "bluecore" / "skills" / "comply" / "fixtures"
