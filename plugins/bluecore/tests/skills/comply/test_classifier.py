...
from bluecore.skills.comply.classifier import _parse_classification, classify_events
...
class TestParseClassification:
    ...
    def test_json_list_returns_empty_dict_with_warning(self, caplog: pytest.LogCaptureFixture) -> None:
        ...
        with caplog.at_level(logging.WARNING, logger="bluecore.skills.comply.classifier"):
...
class TestClassifyEvents:
    ...
    def test_run_cli_success_returns_parsed_result(self, monkeypatch: pytest.MonkeyPatch) -> None:
        from bluecore.skills.comply import classifier as clf_mod
