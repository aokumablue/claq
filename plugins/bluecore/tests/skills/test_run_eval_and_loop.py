...
from bluecore.skills import run_eval, run_loop
from bluecore.skills._eval_config import EvalConfig, SingleQueryConfig
from bluecore.skills.run_loop import LoopConfig
...
def test_run_eval_main_block_invokes_main(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    with pytest.raises(SystemExit) as excinfo:
        runpy.run_module("bluecore.skills.run_eval", run_name="__main__")
...
def test_run_loop_main_entrypoint(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    with pytest.raises(SystemExit) as excinfo:
        runpy.run_module("bluecore.skills.run_loop", run_name="__main__")
...
def test_process_event_line_unknown_type() -> None:
    ...
    from bluecore.skills.run_eval import _process_event_line
