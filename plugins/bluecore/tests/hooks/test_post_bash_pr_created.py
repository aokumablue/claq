...
from bluecore.hooks import post_bash_pr_created as pr_created
...
def test_main_entrypoint_exits_zero_and_writes_stdout(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("bluecore.hooks.hook_common.write_stderr", lambda message: outputs.append(message))
