"""bluecore.ci.validate_install_manifests の追加テスト。"""
...
from bluecore.ci.validate_install_manifests import validate_install_manifests

validate_install_manifests_module = importlib.import_module("bluecore.ci.validate_install_manifests")
...
def test_validate_install_manifests_covers_object_and_entrypoint_branches(
    ...
    with pytest.raises(SystemExit) as excinfo:
        runpy.run_module("bluecore.ci.validate_install_manifests", run_name="__main__")
