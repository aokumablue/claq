"""bluecore.ci.check_unicode_safety のテスト。"""
...
from bluecore.ci import check_unicode_safety
...
def test_validate_unicode_safety_skips_unreadable_files_and_entrypoint(
    ...
    with pytest.raises(SystemExit) as excinfo:
        runpy.run_module("bluecore.ci.check_unicode_safety", run_name="__main__")
...
def test_scan_unicode_safety_no_change_in_write_mode(tmp_path) -> None:
    ...
    from bluecore.ci.check_unicode_safety import _scan_unicode_safety
