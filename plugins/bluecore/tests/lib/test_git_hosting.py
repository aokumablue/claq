...
class TestNormalizeGitHostingServiceEdgeCases:
    ...
    def test_extract_returns_none_when_normalization_returns_unknown(self, monkeypatch) -> None:
        monkeypatch.setattr("bluecore.lib.git_hosting.normalize_git_hosting_service", lambda value, default="github": "bitbucket")
...
def test_normalize_invalid_value_and_invalid_default() -> None:
    ...
    from bluecore.lib.git_hosting import GITHUB, normalize_git_hosting_service
...
def test_normalize_empty_value_with_valid_default() -> None:
    ...
    from bluecore.lib.git_hosting import normalize_git_hosting_service
