...
from bluecore.lib.install_targets.claude_home import claude_home_adapter
from bluecore.lib.install_targets.install_target_helpers import PlanParams, ScaffoldParams
...
class TestClaudeHomeAdapter:
    ...
    def test_get_install_state_path(self, tmp_path):
        ...
        expected = str(tmp_path / ".claude" / "bluecore" / "install-state.json")
        assert result == expected
