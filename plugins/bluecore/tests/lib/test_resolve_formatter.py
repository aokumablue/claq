...
from bluecore.lib.resolve_formatter import (
    BIOME_CONFIGS,
    FORMATTER_PACKAGES,
    PRETTIER_CONFIGS,
...
class TestGetRunnerFromPackageManager:
    ...
    def test_returns_runner_info(self, tmp_path, monkeypatch):
        ...
        from bluecore.lib import package_manager as package_manager
        from bluecore.lib.package_manager import PACKAGE_MANAGERS, PackageManagerResult
...
def test_detect_formatter_package_json_without_prettier(tmp_path) -> None:
    ...
    from bluecore.lib.resolve_formatter import detect_formatter
