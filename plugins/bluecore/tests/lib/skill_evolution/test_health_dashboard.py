...
from bluecore.lib.skill_evolution import dashboard as dashboard
from bluecore.lib.skill_evolution import health as health
from bluecore.lib.skill_evolution import provenance as provenance
from bluecore.lib.skill_evolution import tracker as tracker
from bluecore.lib.skill_evolution import versioning as versioning
...
def test_collect_skill_health_and_format_report(skill_env, make_skill, append_jsonl, now):
    ...
    assert "bluecore skill health" in human
...
def test_filter_records_within_days_and_bucket_by_day_cutoffs(now):
    ...
    from bluecore.lib.skill_evolution.dashboard import bucket_by_day
...
def test_dashboard_primitives_and_panels(skill_env, make_skill, append_jsonl, now):
    ...
    assert "bluecore Skill Health Dashboard" in dashboard_result["text"]
...
def test_list_skills_in_root_skips_dir_without_skill_md(tmp_path) -> None:
    ...
    from bluecore.lib.skill_evolution.health import _list_skills_in_root
...
def test_build_failure_clusters_record_without_skill_id() -> None:
    ...
    from bluecore.lib.skill_evolution.dashboard import _build_failure_clusters
...
def test_collect_skill_ids_skips_entry_without_id() -> None:
    ...
    from bluecore.lib.skill_evolution.dashboard_normalize import _collect_skill_ids
...
def test_discover_skills_dedupes_same_skill_id(tmp_path) -> None:
    ...
    from bluecore.lib.skill_evolution.health import discover_skills
