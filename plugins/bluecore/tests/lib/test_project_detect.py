...
from bluecore.lib.project_detect import (
    FRAMEWORK_RULES,
    LANGUAGE_RULES,
    ProjectInfo,
    detect_frameworks,
...
def test_get_js_test_command_no_test_script(tmp_path) -> None:
    ...
    from bluecore.lib.project_detect.commands import _get_js_test_command
...
def test_scan_dir_skips_broken_symlink(tmp_path) -> None:
    ...
    from bluecore.lib.project_detect.languages import _scan_dir
