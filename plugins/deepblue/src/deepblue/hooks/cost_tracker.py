...
from deepblue.hooks.hook_common import parse_json_object, read_raw_stdin, write_stdout
from deepblue.lib.core_utils import append_file, ensure_dir, get_deepblue_dir
...
def main() -> int:
    ...
    if input_data is not None:
        ...
        metrics_dir = get_deepblue_dir() / "metrics"
