...
分割前の単一モジュール ``deepblue.lib.project_detect`` と同一の名前空間を保つため、
...
from deepblue.lib.project_detect.commands import (
...
from deepblue.lib.project_detect.frameworks import (
    detect_frameworks as detect_frameworks,
)
from deepblue.lib.project_detect.languages import (
    _limited_file_scan as _limited_file_scan,
)
from deepblue.lib.project_detect.languages import (
    detect_languages as detect_languages,
)
from deepblue.lib.project_detect.models import (
...
from deepblue.lib.project_detect.rules import (
