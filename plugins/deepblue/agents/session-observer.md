...
- プロジェクト: `~/.deepblue/projects/<project-hash>/observations.jsonl`
...
- プロジェクト: `~/.deepblue/projects/<project-hash>/instincts/personal/`
...
昇格は `deepblue.skills.learn.cli promote` コマンドまたは `/instinct evolve` の分析で行われる。
