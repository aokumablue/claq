...
from deepblue.redux import loader
from deepblue.redux.engine import ReduxEngine, apply_spec
...
class TestPaths:
    def test_user_filter_paths_order(self) -> None:
        ...
        assert paths[0] == Path.cwd() / ".deepblue" / "redux" / "filters.toml"
        assert paths[1] == Path.home() / ".deepblue" / "redux" / "filters.toml"
