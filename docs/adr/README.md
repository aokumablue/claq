...
| [0008](0008-plugin-root-resolved-via-home-ple4-env-pointer.md) | plugin root は `~/.ple4/env.sh` ポインタで解決し、md にベンダ固有パスを書かない | accepted | 2026-08-20（改訂 ×5、最新 2026-08-27） |
