...
| [0008](0008-plugin-root-resolved-via-home-bluecore-env-pointer.md) | plugin root は `~/.bluecore/env.sh` ポインタで解決し、md にベンダ固有パスを書かない | accepted | 2026-08-20（2026-08-20 改訂 ×2） |
